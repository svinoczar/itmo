# ITMO
#### :exclamation:Attention, the sub-modules are temporarily not working, they will be set up with the release of a new version of the script from [ruddnev](github.com/ruddnev) in early February.:exclamation:  
...
- ["Pokemons" - work with packages and OOP (2nd lab)](https://github.com/svinoczarITMO/s1-prog-lab2/tree/main)
